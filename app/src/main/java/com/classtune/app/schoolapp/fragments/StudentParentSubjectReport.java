...
public class StudentParentSubjectReport extends UserVisibleHintFragment{
    ...
    private void initApiCallSubjet() {
       ...
       // AppRestClient.post(URLHelper.URL_STD_PARENT_SUBJECT, params, subjectHandler);
        stdParentSubject(params);
    }

    private void stdParentSubject(HashMap<String,String> params){
        uiHelper.showLoadingDialog(getString(R.string.java_accountsettingsactivity_please_wait));
        ApplicationSingleton.getInstance().getNetworkCallInterface().stdParentSubject(params).enqueue(
